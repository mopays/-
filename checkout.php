                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                       ...
                       <select name="method"  class="box" required>
                           <option style="color:#fff;" value="cash on delivery" default> cash on delivery</option>
                           <option  style="color:#fff;" value="credit card">credit card</option>
                           <option  style="color:#fff;" value="K+">K+</option>
                       </select>
                    </div>
                    <div class="inputBox">
